...
// campo com 1ª Letra maiúscula p/ liberar o acesso de outro arquivo
type Payload struct {
	Cpf                   string
	Private               bool
	Incomplete            bool
...
func DataPayload(data []string) Payload {
	...
	// TODOS CAMPOS STRUCT:
	return Payload{cpf, private, incomplete, dateLastPurchase, ticketAverage, ticketLastPurchase, cnpjStoreMostFrequent, cnpjStoreLastPurchase}
